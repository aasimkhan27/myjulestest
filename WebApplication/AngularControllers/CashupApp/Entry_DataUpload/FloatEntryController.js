app.controller('FlaotEntryController', function ($scope, $http, CommService, $cookies, $filter, PrcCommMethods, $location) {
    ...
    $scope.EXPORT_PAGE_TO_PDF = function () {
        ...
        CashupAppModelObj.PAGE_NO = 0;
        CashupAppModelObj.PAGE_SIZE = 0;
        CashupAppModelObj.FILE_PATH = "/FLOAT_ENTRY_REPORT_" + "/CUSTOMER_" + $scope.FloatEntrySearch.CUSTOMER_ID + "/" + "USER_ID_" + $scope.FloatEntrySearch.USER_ID + "/PDF/";
        CashupAppModelObj.FILE_NAME = "Float Entry Report";
        CashupAppModelObj.LOGO_PATH = $scope.$parent.$parent.LOGO_PATH;
        CashupAppModelObj.BRANCH_NAME = $scope.FloatEntrySearch.SELECTED_SITE.BRANCH_NAME;
        PrcCommMethods.CASHUP_APP_API(CashupAppModelObj, 'PRINT_TO_PDF').then(function (data) {
