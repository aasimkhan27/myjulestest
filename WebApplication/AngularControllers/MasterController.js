...
if (window.location.href.toLowerCase().indexOf("dashboard/index") != -1 || window.location.href.toLowerCase().indexOf("dashboard/hrindex") != -1
    || window.location.href.toLowerCase().indexOf("report/reportindex") != -1) {
...
if (window.location.href.toLowerCase().indexOf("dashboard/hrindex") != -1 || window.location.href.toLowerCase().indexOf("scheduler/indexscheduler") != -1
    || window.location.href.toLowerCase().indexOf("Payment/Index") != -1) {
...
if (window.location.href.toLowerCase().indexOf("dashboard/powerinsightindex") != -1 ) {
    _requires = ['ngCookies', 'ngRoute', 'ngAnimate', 'ngStorage', 'ngSanitize', 'moment-picker', 'ui.bootstrap'];
}
if (window.location.href.toLowerCase().indexOf("main/adminindex") != -1 || window.location.href.toLowerCase().indexOf("hr/hrindex") != -1 || window.location.href.toLowerCase().indexOf("hr/hrm_o_index") != -1 || window.location.href.toLowerCase().indexOf("cashup/cashupappindex") != -1  ) {
