...
describe('HTML', function() {
  ...
  describe('SVG support', function() {
    ...
    it('should sanitize SVG xml:base attribute values', function() {
      expectHTML('<svg xmlns="http://www.w3.org/2000/svg"><a xml:base="javascript:alert(1)//" ></a></svg>')
        .toEqual('<svg xmlns="http://www.w3.org/2000/svg"><a ></a></svg>');

      expectHTML('<svg xmlns="http://www.w3.org/2000/svg"><a xml:base="https://example.com" ></a></svg>')
        .toEqual('<svg xmlns="http://www.w3.org/2000/svg"><a xml:base="https://example.com" ></a></svg>');
