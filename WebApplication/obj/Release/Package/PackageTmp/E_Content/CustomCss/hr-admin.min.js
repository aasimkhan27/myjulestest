...
function(s) {
    ...
    n.prototype.toggle = function (t, e) {
        ...
        n.is(a) && (this.options.followLink && "#" !== t.attr("href") || e.stopImmediatePropagation(), i ? this.collapse(o, n) : this.expand(o, n))
...
function(a) {
    ...
    var s = "lte.layout",
        ...
        h = ".main-footer",
        f = ".main-header",
        t = ".Wenodo-main-sidebar",
        e = "slimScrollDiv",
        p = ".Wenodo-sidebar",
        u = ".control-sidebar",
        o = ".Wenodo-sidebar-menu",
        n = ".main-header .logo",
        g = "fixed",
        v = "hold-transition";
