var FwBootstrap = function (e) {
    ...
    }, n.p = "https://euc-widget.freshworks.com/widgetBase/", n(n.s = 0)
}([function (e, t, n) {
    e.exports = n(2)
}, function (e, t) {
    ...
    var s = ["FrustrationTracking", "Predictive"],
        ...
        o = {
            ...
            settings:
            {
                ...
                {
                    welcome_message: "",
                    message: "We noticed youâ€™re stuck. Tell us what you were trying to accomplish, and our support team will reach out to you as soon as possible.",
    ...
    var d = {
        ...
        fetchSettings: function (e, t) {
            ...
            n.onreadystatechange = function () {
                4 === n.readyState && 200 === n.status && t(function (e) {
                    try {
                        return JSON.parse(e)
                    }
                    catch (t) {
            ...
            }, n.open("get", e), n.responseType = "json", n.send()
        },
        showWidget: function (e) {
            var t = !1,
                ...
                s = e.settings,
                i = e.components;
            return (i || s.components) && ["contact_form", "solution_articles", "frustration_tracking", "predictive_support"].forEach(function (e) {
                var o = n && n.data_version && i ? i[e] && i[e].enabled : s.components[e];
                t = t || Boolean(o)
            }), t
        },
        initWidget: function (e) {
            var t;
            null != (t = e) && 0 !== Object.keys(t).length && e && this.showWidget(e) && (this.options = e, window.fwSettings.originUrl = this.origin, window.fwSettings.options = e, this.messageHandler = this.handleMessage.bind(this), this.createMountPoint(), this.loadIFrame(), this.loadJS())
        },
        createMountPoint: function () {
            //debugger;
            var e = document.createElement("div");
            e.id = "freshworks-container", e.style.display = "none",e.style.width = "0px", e.style.height = "0px", e.style.bottom = "0px", e.style.right = "0px", e.style.zIndex = Number.MAX_SAFE_INTEGER, e.setAttribute("data-html2canvas-ignore", !0), document.body.appendChild(e);
            var t = n(1),
                s = document.createElement("link");
            s.id = "freshworks-frame", s.rel = "stylesheet", s.href = t, document.head.appendChild(s)
        },
        loadIFrame: function () {
            var e = document.createElement("iframe");
            e.setAttribute("title", "FreshworksWidget"), e.setAttribute("id", "freshworks-frame"), e.setAttribute("data-html2canvas-ignore", !0), e.style.display = "none", e.onload = function () {
                var t = document.createElement("link");
                t.setAttribute("rel", "preconnect"), t.setAttribute("href", "https://euc-widget.freshworks.com/widgetBase"), e.contentDocument.head.appendChild(t)
            }, document.body.appendChild(e), this._frame = e;
            var t = e.contentDocument || e.document;
            t.open();
            //var n = '<script src="'.concat("https://euc-widget.freshworks.com/widgetBase", '/widget.js" async defer><\/script>');
            var n = '<script src="../E_Scripts/FreshDesk/widget.js" async defer></script>';
        ...
        helpWidgetMethods: function (e, t, n) {
            if (e && d[e] && a(Object.keys(i), e)) return d[e](t, n)
        },
        widgetRenderComplete: function () {
            var e = window.FreshworksWidget && window.FreshworksWidget.q || [];
            window.FreshworksWidget = this.helpWidgetMethods, e.forEach(function (e) {
                window.FreshworksWidget.apply(null, e)
            }), this.postMessage(i.boot)
        },
        bindMessageHandler: function () {
            this.postMessageHandlerBound || (this.postMessageHandlerBound = !0, window.addEventListener ? window.addEventListener("message", this.messageHandler, !0) : window.attachEvent("message", this.messageHandler, !0))
        },
        unbindMessageHandler: function () {
            this.postMessageHandlerBound && (this.postMessageHandlerBound = !1, window.removeEventListener ? window.removeEventListener("message", this.messageHandler, !0) : window.detachEvent("message", this.messageHandler, !0))
        },
        ...
        boot: function () {
            this.bindMessageHandler(), this._frame.contentWindow.Widget.mount(this.origin), this.postMessage(i.boot)
        },
        isFrustrationTrackingEnabled: function () {
            var e = this.options,
                ...
                n = e.settings,
                s = e.components;
            return t && t.data_version && s ? s.frustration_tracking && Boolean(s.frustration_tracking.enabled) : Boolean(n.components.predictive_support)
        },
        ...
        authenticate: function (e) {
            var t = e.callback,
                ...
                r = s || o;
            s && (this.authenticateCallback = t), this.postMessage(i.authenticate,
                {
                    token: n,
                    hasCallback: r
                })
